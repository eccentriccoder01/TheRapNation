...
TAGMES = [ " **❅ बेबी कहा हो। 🤗** ",
           ...
           " **❅ ये attitude किसे @filmdom_updates दिखा रहे हो 😮** ",
           " **❅ हेमलो कहा busy ho 👀** ",
...
async def mentionall(client, message):
    ...
    try:
        ...
        if participant.status in (
            ...
            is_admin = True
    if not is_admin:
        return await message.reply("๏ ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀɴ ᴀᴅᴍɪɴ ʙᴀʙʏ, ᴏɴʟʏ ᴀᴅᴍɪɴs ᴄᴀɴ ᴛᴀɢ ᴍᴇᴍʙᴇʀs. ")
