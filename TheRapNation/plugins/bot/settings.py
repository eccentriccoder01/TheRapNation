...
from TheRapNation.utils.decorators.admins import ActualAdminCB
from TheRapNation.utils.decorators.language import language, languageCB
from TheRapNation.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from TheRapNation.utils.inline.start import private_panel
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaVideo("https://tinyurl.com/27524phc"),
