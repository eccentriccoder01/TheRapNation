...
from TheRapNation.utils import HottyBin, get_channeplayCB, seconds_to_min
from TheRapNation.utils.database import get_cmode, is_active_chat, is_music_playing
from TheRapNation.utils.decorators.language import language, languageCB
from TheRapNation.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://i.pinimg.com/1200x/90/4e/72/904e72077d4090d98e75444234daa20e.jpg",
        caption=_["queue_1"],
    )
