...
from TheRapNation.utils import first_page, second_page
from TheRapNation.utils.database import get_lang
from TheRapNation.utils.decorators.language import LanguageStart, languageCB
from TheRapNation.utils.inline.help import help_back_markup, private_help_panel
    ...
    if cb == "hb9":
        if CallbackQuery.from_user.id not in SUDOERS:
            return await CallbackQuery.answer(
                "𝐓𝐡𝐞 𝐑𝐚𝐩 𝐍𝐚𝐭𝐢𝐨𝐧 | 𝟗𝟎𝐬 𝐇𝐢𝐩-𝐇𝐨𝐩 🎤", show_alert=True
            )
        else:
