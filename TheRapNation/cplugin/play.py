...
import config
from TheRapNation import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from TheRapNation.core.call import Hotty
from TheRapNation.misc import SUDOERS
from TheRapNation.utils.inline import panel_markup_clone
from TheRapNation.utils import seconds_to_min, time_to_seconds
from TheRapNation.utils.channelplay import get_channeplayCB
from TheRapNation.utils.decorators.language import languageCB
from TheRapNation.utils.decorators.play import CPlayWrapper
from TheRapNation.utils.formatters import formats
from TheRapNation.utils.inline import (
    botplaylist_markup,
    livestream_markup,
    playlist_markup,
    slider_markup,
...
from TheRapNation.utils.database import (
...
from TheRapNation.utils.logger import play_logs
from config import BANNED_USERS, lyrical
from time import time
from TheRapNation.utils.extraction import extract_user
    ...
    if current_time - last_message_time < SPAM_WINDOW_SECONDS:
        ...
        if user_command_count[user_id] > SPAM_THRESHOLD:
            ...
            hu = await message.reply_text(
                f"**{message.from_user.mention} ᴘʟᴇᴀsᴇ ᴅᴏɴ'ᴛ sᴘᴀᴍ, ᴀɴᴅ ᴛʀʏ ᴀɢᴀɪɴ ᴀғᴛᴇʀ 5 sᴇᴄ**"
            )
...
import config
from TheRapNation import Carbon, YouTube
from TheRapNation.core.call import Hotty
from TheRapNation.misc import db
from TheRapNation.utils.database import add_active_video_chat, is_active_chat
from TheRapNation.utils.exceptions import AssistantErr
from TheRapNation.utils.inline import (
    aq_markup,
    queuemarkup,
    close_markup,
...
from TheRapNation.utils.pastebin import HottyBin
from TheRapNation.utils.stream.queue import put_queue, put_queue_index
