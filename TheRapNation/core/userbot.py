...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("TheRapNation")
                await self.one.join_chat("eccentricexplorer")
                await self.one.join_chat("Filmdom_Updates")
                await self.one.join_chat("hiskindle0")
